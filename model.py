...
class StreamingM3():
    ...
    def __init__(self, p):
        ...
        #load model
        self.model = Task5Modelb(p.num_classes, model_arch="pann_cnn10", pann_encoder_ckpt_path=p.pann_encoder_ckpt_path).to(p.device)
        self.model_path = "model/trying_pann_cbam_fdy_head_16k/16.0k/model_logmelspec_012_pann_cnn10_use_cbam_True"
        self.load_model(self.model_path)
