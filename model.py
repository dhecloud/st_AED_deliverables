...
import numpy as np
from utils import Task5Model, getSampleRateString, Task5Modelb
import librosa
...
class StreamingM2():
    ...
    def __init__(self, p):
        ...
        #load model
        self.model = Task5Modelb(p.num_classes, model_arch="mobilenetv2", pann_encoder_ckpt_path=p.pann_encoder_ckpt_path).to(p.device)
